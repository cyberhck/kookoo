			...
			<div class="wrapper wrapper-content">
				...
				<div class="row">
					<div class="col-lg-6">
						...
						<h3>3 CSE
							<div class="stat-percent text-navy">78%</div>
						</h3>
					</div>
						<div class="ibox-content">
							Absent <div class="stat-percent text-navy">5</div>
						</div>
					</div>
				</div>
				...
				<div class="col-lg-6">
					<div class="ibox float-e-margins">
						...
						<div class="ibox-content ibox-heading">
						<h3>5 CSE
							<div class="stat-percent text-navy">90%</div>
						</h3>
					</div>
						<div class="ibox-content">
							Absent <div class="stat-percent text-navy">7</div>
						</div>
					</div>
				</div>
				</div>
				...
				<div class="row">
					<div class="col-lg-6">
						...
						<div class="ibox-content ibox-heading">
						<h3>7 CSE 'A'
							<div class="stat-percent text-navy">88%</div>
						</h3>
					</div>
						<div class="ibox-content">
							Absent <div class="stat-percent text-navy">8</div>               
						</div>
					</div>
				</div>
				...
				<div class="col-lg-6">
					<div class="ibox float-e-margins">
						...
						<div class="ibox-content ibox-heading">
						<h3>7 CSE 'B'
							<div class="stat-percent text-navy">73%</div>
						</h3>
					</div>
						<div class="ibox-content">
							Absent <div class="stat-percent text-navy">9</div>
						</div>
					</div>
				</div>
				</div>
